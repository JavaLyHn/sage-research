...
目标产品 **https://www.pika.me/** 在本次深度体验中：存在显著的功能信息缺口。详见 §3 体验流程记录。
...
| 产品线时间轴 | 2023-04 公司成立 → 2023-11 Series A → 2024-06 Series B → **2026-02 推出 pika.me / AI Selves（本次体验对象）** | ✅ |

**关键判读提示**：本次体验的 pika.me 是 Pika Labs 在 2026 年的**战略品类切换**——从纯 AI 视频生成转向"AI 身份/数字分身"赛道。已有的 $135M 资金与团队是其**核心竞争壁垒**，但 pika.me 作为新产品仍处于早期市场验证阶段，融资/估值数据**不应被解读为 pika.me 产品本身的成功指标**，而是母公司的弹药储备。
...
目标产品 **https://www.pika.me/** 在 **ai-tool** 模板的 **standard** 档位评测下存在严重问题：识别问题 63 个（P1 28 / P2 28 / P3 7），正面发现 16 个。详见 §3 体验流程与 §3 问题清单。
